...
%  wls=[16 15 16 13 13 14 15 15 13 11  ];
%  is= [7  7  4  4  7  9  7  2  5  6   ];
%  js= [16 11 16 16 12 12 13 6  9  12  ];
% .8201
%70 .7779  50 .7637!!  50pow33 .8647   unique .8576
% p2
...
%  p=2;
%  wls=[10 10 14 12 14 11 ];
%  is= [12 5  12 12 3  3  ];
%  js= [14 12 15 16 14 5  ];
 
%0.8569
%70 8566  50 .8182   pow33 7883 unique .7790
% p3
...
p=3;
wls=[13 10 12 13 8 6  11 16];
is= [11 6  7  6  2 6  1 6 ];
js= [16 11 8  8  6 13 8 15 ];       %78886
%0.8251
