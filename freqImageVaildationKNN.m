...
% % %        d3= sortrows(d3,2);
        ...
        d2=d1sFreqCorr{p}{testIndices(i)}(trainIndices,:);
    ...
    [X,Y,T,u15]=perfcurve(safeFiles{p}.all.class(testIndices),us14(:,kn)+us7(:,kn),1);
    ...
    plot(allu15,'color',cols{p},'LineStyle','-','LineWidth',3,'Marker','+');hold on;
